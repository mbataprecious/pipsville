...
export const crypto = [
  {
    title: 'Mining and NFTs ',
    details:
      'we participates in providing cloud server mining and incorporates Proof of Stake (PoS) using technology, developed by a Group of Experts in the field of IT and Cryptocurrencies(BTC).',
    color: 'FF9F43',
  },
  {
    title: 'housing and RealEstate',
