...
import { Box, Stack, Switch, FormControlLabel, Typography } from '@mui/material';
      ...
      <FormikProvider value={formik}>
        <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
          <Stack direction="column" spacing={1}>
            ...
            />
            <FormControlLabel
              control={<Switch name="withdrawal" onChange={handleChange} checked={values.withdrawal} />}
              label="Notify when Withdrawal is ready"
            />
            <FormControlLabel
              control={<Switch name="email" onChange={handleChange} checked={values.email} />}
