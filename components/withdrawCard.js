...
import { Typography, TextField, MenuItem, Card, Box, CardContent, Stack, Grid } from '@mui/material';
            ...
            <Grid item xs={12} sm={12} md={6}>
              <Box>
                ...
                <TextField
                  ...
                  error={error}
                  helperText={error && 'amount must not be greater than account balance'}
                />
              </Box>
            </Grid>
